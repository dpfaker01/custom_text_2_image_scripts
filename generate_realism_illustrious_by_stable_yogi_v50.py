...
DEFAULT_PROMPT = (
    ...
    "cinematic bokeh, photorealistic, 4k, high resolution, sharp focus"
)
DEFAULT_NEGATIVE_PROMPT = (
    "nsfw, (low quality, worst quality:1.2), cartoon, anime, 3d, painting, drawing, sketch, "
    "watermark, text, blurry, mutated hands, poorly drawn hands, extra fingers, missing fingers, deformed hands, extra arms, extra legs, extra feet, extra hands"
)
SEED = -1
WIDTH = 1024
HEIGHT = 1024
...
try:
    ...
    pipe.fuse_lora(lora_scale=0.8)  # Adjust 0.6–1.0 based on strength needed
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate images with custom hand-fix LoRA"
    )
...
if __name__ == "__main__":
    ...
    print("🚀 Starting image generation with custom hand-fix LoRA...")
